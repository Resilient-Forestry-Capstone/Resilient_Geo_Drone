  ...
  def run(self):
    try:
      ...
      try:
        ...
        webodm_results = self.webodm_client.generate_point_cloud_signal(valid_images, self.config_loader.load()['point_cloud']['webodm']['active_environment'], self.progress_updated_status)
      except Exception as e:
      ...
      try:
        ...
        self.gap_detector.process_gaps(self.webodm_client.output_dir / "chm.tif", self.webodm_client.output_dir)
